...
capitals = {'Alabama': 'Montgomery', 'Alaska': 'Juneau', 'Arizona': 'Phoenix',
            ...
            'Missouri': 'Jefferson City', 'Montana': 'Helena', 'Nebraska':
            'Lincoln', 'Nevada': 'Carson City', 'New Hampshire': 'Concord',
            'New Jersey': 'Trenton', 'New Mexico': 'Santa Fe', 'New York':
            'Albany', 'North Carolina': 'Raleigh', 'North Dakota': 'Bismarck',
...
for quizNum in range(35):
    ...
    # Write out the header for the quiy
    quizFile.write('Name\n\nDate:\n\nPeriod:\n\n')
